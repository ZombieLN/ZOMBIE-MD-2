    ...
    if (connection === 'close') {
        ...
        setTimeout(async () => {
            try {
                ...
                let captionText = '✅ ZOMBIE connected successfully!';
                try {
                ...
                await conn.sendMessage(DEFAULT_OWNER_JID, {
                    image: { url: 'https://github.com/ZombieOFC/Zombie-db/raw/main/Imageurl/file_00000000b2c87246bf4aeea722e8ac5a.png' },
                    caption: captionText
                });
...
*\`• Logo :\`* ${logo ?? "https://github.com/ZombieOFC/Zombie-db/raw/main/Imageurl/file_00000000b2c87246bf4aeea722e8ac5a.png"}
...
app.get("/", (req, res) => {
  res.send("📁 ZOMBIE STARTED SUCCESSFULLY!");
});
app.listen(port, () => console.log(`Zombie-Inject-Bot Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 3000);
